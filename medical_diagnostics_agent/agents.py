...
class MultidisciplinaryTeam:
    ...
    def __init__(self, cardiologist_report: str, psychologist_report: str, pulmonologist_report: str, model_name: str = "gpt-4o"):
...
async def run_medical_diagnosis(medical_report: str, model_name: str = "gpt-4o") -> str:
    ...
    specialist_reports = dict(zip(agent_names, responses))
